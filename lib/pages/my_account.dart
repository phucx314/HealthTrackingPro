    ...
    if (userCurrent != null) {
      ...
      try {
        await FirebaseFirestore.instance
            ...
            .doc(uid)
            .update(newData);
        // Nếu cập nhật thành công, bạn cũng có thể cập nhật lại state hoặc thực hiện hành động khác ở đây.
        ...
        body: SafeArea(
          child: Column(
            children: [
              const Padding(
                padding:
                    EdgeInsets.only(bottom: 25, top: 25, right: 25, left: 25),
                child: MyAppBar(
                  username: 'username',
                ),
              ),
              Stack(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(25, 96 + 15, 25, 0),
                    child: Positioned(
                      top: 96 + 15,
                      child: Container(
                        width: MediaQuery.of(context).size.width,
